...
# GPU recon (SIRT)
recon = tomopy.recon(projs, theta, center=COR, algorithm='sirt', sinogram_order=False, accelerated=True)

# apply circular mask
recon = tomopy.circ_mask(recon, axis=0, ratio=0.95)

# write output npy file
fileout = path_recon+'recon_GPU.npy'
np.save(fileout, recon)

# write output slice as npy file
fileout = path_recon+'slice200_GPU.npy'
