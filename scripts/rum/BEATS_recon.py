...
def main():
    ...
    parser.set_defaults(fullturn=False, phase=False, phase_pad=False, circ_mask=False, write_midplanes=True,
                        verbose=False)
    ...
    if args.fullturn:
        logging.info("Convert 360 to 180 degrees sinograms. Rotation axis: {0}; Overlap: {1}.".format(args.rotside,
                                                                                                      args.overlap))
    ...
    dxchange.writer.write_tiff_stack(recon,
